...
//&*&*&*AL1_110830: add enable attribute for switch specify regulator
		...
		struct device_attribute *attr, const char *buf, size_t count)
{
	...
	printk("[regulator_core.c]Enter %s, regulator device name:%s, regulator use count:%d\n", __FUNCTION__, rdev_get_name(rdev), rdev->use_count);
	
	return count;
}
static DEVICE_ATTR(enable, S_IRUGO|S_IWUSR|S_IWGRP, NULL, regulator_enable_store);
//&*&*&*AL2_110830: add enable attribute for switch specify regulator
