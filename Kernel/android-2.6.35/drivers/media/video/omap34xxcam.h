 ...
 * @current_sensor: the sensor which being used		//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
...
struct omap34xxcam_videodev {
	...
	int current_sensor;			//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
