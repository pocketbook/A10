...
printk("[mt9d115 Sensor]Enter %s preveiw val = 0x%x enter_preview again\n", __FUNCTION__,val); 
				    ...
				    if (j>=2)
				    {
printk("[mt9d115 Sensor]Enter %s preveiw val = 0x%x enter_preview fail\n", __FUNCTION__,val); 
				      break;
				    }  
				    goto enter_preview;
				}    
...
printk("[mt9d115 Sensor]Enter %s capture val = 0x%x enter_capture again\n", __FUNCTION__,val); 
				    ...
				    if (j>=2)
				    {
printk("[mt9d115 Sensor]Enter %s capture val = 0x%x enter_capture fail\n", __FUNCTION__,val); 
				      break;
				    }  
				    goto enter_capture;
				}    
...
printk("[mt9d115 Sensor]Enter %s stream_off status = 0x%x fail\n", __FUNCTION__,status); 
	     ...
	     if ( !(status & 0x1))
	     {
printk("[mt9d115 Sensor]Enter %s stream_off again\n", __FUNCTION__);
		goto stream_off;	
	     }		
