...
#include <linux/device.h>	//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
...
//#if 0	//&*&*&*JJ1		//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
...
////&*&*&*JJ1 Add camera endianness
//				reg &= ~ISPCSI2_CTRL_ENDIANNESS_MASK;
//				reg |= ISPCSI2_CTRL_ENDIANNESS_LITTLE_ENDIAN;
////&*&*&*JJ2 Add camera endianness
//&*&*&*CJ2_20110811_mod: follow TI MMS' solution for camera driver
		isp_reg_writel(isp_csi2->dev, reg, OMAP3_ISP_IOMEM_CSI2A,
			       ISPCSI2_CTRL);
...
{
printk("\t### <%s>[%d] Enable:%d\n", __func__, __LINE__, enable);	//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
	if (enable) {
#ifdef CONFIG_VIDEO_OMAP34XX_ISP_DEBUG_FS
