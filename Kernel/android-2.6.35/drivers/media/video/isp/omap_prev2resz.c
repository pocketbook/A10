...
static int prev2resz_ioc_set_config(struct prev2resz_fhdl *fh)
{
	...
	struct isp_device *isp = dev_get_drvdata(fh->isp);	//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
	int rval, rest;
	...
	isp->pipeline.prv = fh->prev;	//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
	...
	isp->pipeline.rsz = fh->resz;	//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
