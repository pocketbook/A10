				   ...
				   struct isp_pipeline *pipe)
{
	...
	case CCDC_YUV_RSZ:
		...
		ispccdc_enable_vp(isp_ccdc, 0);		//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
		ispccdc_enable_lsc(isp_ccdc, 0);	//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
		break;
		       ...
		       struct isp_pipeline *pipe)
{
    ...
    pipe->ccdc_in_w -= 16;		//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
    pipe->ccdc_in_h -= 8;		//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
