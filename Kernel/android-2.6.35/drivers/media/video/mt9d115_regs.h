...
/* //&*&*&*CJ1_20110830 to fix camera sensor horizontal noise issue. */
//#define MT9D115_XCLK_NOM_1 	24000000
//#define MT9D115_XCLK_NOM_2 	24000000
#define MT9D115_XCLK_NOM_1 	18000000
#define MT9D115_XCLK_NOM_2 	18000000
/* //&*&*&*CJ1_20110830 to fix camera sensor horizontal noise issue. */

/* FPS Capabilities */
#define MT9D115_MIN_FPS		7
#define MT9D115_DEF_FPS		15
#define MT9D115_MAX_FPS		31	/* //&*&*&*CJ_20110712 Implement FPS */
...
/* FPS Values */
#define MT9D115_FPS_MIN		0
#define MT9D115_FPS_MAX		5
#define MT9D115_FPS_STEP	1
#define MT9D115_FPS_DEF		0
#define MT9D115_FPS_AUTO_7_5TO30	0
#define MT9D115_FPS_FIX30	1
#define MT9D115_FPS_FIX24	2
#define MT9D115_FPS_FIX20	3
#define MT9D115_FPS_FIX15	4
#define MT9D115_FPS_FIX10	5
...
/* //&*&*&*CJ1_20110712 Implement FPS */
 /* FPS settings */  
const static struct mt9d115_reg fps_variable_7_5_to_30[] = {	//settings from Rich Power on 6/30
	{0x098C, 0x271F, I2C_16BIT},    // MCU_ADDRESS [SEQ_PREVIEW_1_AWB]      
//	{0x0990, 0x02BB, I2C_16BIT},    // MCU_DATA_0                           
	{0x0990, 0x02B3, I2C_16BIT},    // MCU_DATA_0                           
	{0x098C, 0x2721, I2C_16BIT},    // MCU_ADDRESS [SEQ_MODE]               
//	{0x0990, 0x0888, I2C_16BIT},    // MCU_DATA_0                           
	{0x0990, 0x0565, I2C_16BIT},    // MCU_DATA_0 		  /* //&*&*&*CJ1_20110830 to fix camera sensor horizontal noise issue. */                        
	{0x098C, 0xA20C, I2C_16BIT},    // MCU_ADDRESS [AWB_CCM_POSITION_MIN]   
	{0x0990, 0x0010, I2C_16BIT},    // MCU_DATA_0                           
	{0x098C, 0xA20E, I2C_16BIT},    // MCU_ADDRESS [AWB_CCM_POSITION_MAX]   
	{0x0990, 0x0091, I2C_16BIT},    // MCU_DATA_0                           
//	{0x098C, 0xA103, I2C_16BIT},    // MCU_ADDRESS [AWB_GAIN_MIN]           
...
const static struct mt9d115_reg fps_fix_30[] = {	//settings from Rich Power on 6/30
	{0x098C, 0x271F, I2C_16BIT},    // MCU_ADDRESS [SEQ_PREVIEW_1_AWB]      
	{0x0990, 0x02BB, I2C_16BIT},    // MCU_DATA_0                           
	{0x098C, 0x2721, I2C_16BIT},    // MCU_ADDRESS [SEQ_MODE]               
//	{0x0990, 0x0888, I2C_16BIT},    // MCU_DATA_0                           
...
const static struct mt9d115_reg fps_fix_24[] = {	//settings from Rich Power on 6/30
	{0x098C, 0x271F, I2C_16BIT},    // MCU_ADDRESS [SEQ_PREVIEW_1_AWB]      
	{0x0990, 0x031B, I2C_16BIT},    // MCU_DATA_0                           
	{0x098C, 0x2721, I2C_16BIT},    // MCU_ADDRESS [SEQ_MODE]               
//	{0x0990, 0x0888, I2C_16BIT},    // MCU_DATA_0                           
	{0x0990, 0x0565, I2C_16BIT},    // MCU_DATA_0		/* //&*&*&*CJ1_20110830 to fix camera sensor horizontal noise issue. */                   
	{0x098C, 0xA20C, I2C_16BIT},    // MCU_ADDRESS [AWB_CCM_POSITION_MIN]   
...
const static struct mt9d115_reg fps_fix_20[] = {	//settings from Rich Power on 6/30
	{0x098C, 0x271F, I2C_16BIT},    // MCU_ADDRESS [SEQ_PREVIEW_1_AWB]      
	{0x0990, 0x03BB, I2C_16BIT},    // MCU_DATA_0                           
	{0x098C, 0x2721, I2C_16BIT},    // MCU_ADDRESS [SEQ_MODE]               
//	{0x0990, 0x0888, I2C_16BIT},    // MCU_DATA_0                           
	{0x0990, 0x0565, I2C_16BIT},    // MCU_DATA_0		/* //&*&*&*CJ1_20110830 to fix camera sensor horizontal noise issue. */                           
	{0x098C, 0xA20C, I2C_16BIT},    // MCU_ADDRESS [AWB_CCM_POSITION_MIN]   
	{0x0990, 0x0006, I2C_16BIT},    // MCU_DATA_0                           
	{0x098C, 0xA20E, I2C_16BIT},    // MCU_ADDRESS [AWB_CCM_POSITION_MAX]   
	{0x0990, 0x0060, I2C_16BIT},    // MCU_DATA_0                           
//	{0x098C, 0xA103, I2C_16BIT},    // MCU_ADDRESS [AWB_GAIN_MIN]           
//	{0x0990, 0x0006, I2C_16BIT},    // MCU_DATA_0                           
//	{0x098C, 0xA103, I2C_16BIT},    // MCU_ADDRESS [SEQ_CMD]                
//	{0x0990, 0x0005, I2C_16BIT},    // MCU_DATA_0                           
...
const static struct mt9d115_reg fps_fix_15[] = {	//settings from Rich Power on 6/30
	{0x098C, 0x271F, I2C_16BIT},    // MCU_ADDRESS [SEQ_PREVIEW_1_AWB]      
	{0x0990, 0x04FB, I2C_16BIT},    // MCU_DATA_0                           
	{0x098C, 0x2721, I2C_16BIT},    // MCU_ADDRESS [SEQ_MODE]               
//	{0x0990, 0x0888, I2C_16BIT},    // MCU_DATA_0                           
	{0x0990, 0x0565, I2C_16BIT},    // MCU_DATA_0 		/* //&*&*&*CJ1_20110830 to fix camera sensor horizontal noise issue. */
	{0x098C, 0xA20C, I2C_16BIT},    // MCU_ADDRESS [AWB_CCM_POSITION_MIN]   
...
const static struct mt9d115_reg fps_fix_10[] = {	//settings from Rich Power on 6/30
	{0x098C, 0x271F, I2C_16BIT},    // MCU_ADDRESS [SEQ_PREVIEW_1_AWB]      
	{0x0990, 0x077B, I2C_16BIT},    // MCU_DATA_0                           
	{0x098C, 0x2721, I2C_16BIT},    // MCU_ADDRESS [SEQ_MODE]               
//	{0x0990, 0x0888, I2C_16BIT},    // MCU_DATA_0                           
	{0x0990, 0x0565, I2C_16BIT},    // MCU_DATA_0		/* //&*&*&*CJ1_20110830 to fix camera sensor horizontal noise issue. */
	{0x098C, 0xA20C, I2C_16BIT},    // MCU_ADDRESS [AWB_CCM_POSITION_MIN]   
...
//	{0x0010, 0x0115, I2C_16BIT}, 	// PLL_DIVIDERS
	{0x0010, 0x0223, I2C_16BIT}, 	// PLL_DIVIDERS	/* //&*&*&*CJ1_20110830 to fix camera sensor horizontal noise issue. */
...
//	{0x0990, 0x02BB, I2C_16BIT}, 	// MCU_DATA_0  //sam 0x02B3                                                                        
//	{0x098C, 0x2721, I2C_16BIT}, 	// MCU_ADDRESS [MODE_SENSOR_LINE_LENGTH_PCK_A]                                         
//	{0x0990, 0x0888, I2C_16BIT}, 	// MCU_DATA_0  //sam 0x0679                                                                      
...
//	{0x0990, 0x0521, I2C_16BIT}, 	// MCU_DATA_0   //sam 0x050D                                                                       
	{0x0990, 0x050D, I2C_16BIT}, 	// MCU_DATA_0   //sam 0x050D                                                                       
	{0x098C, 0x2737, I2C_16BIT}, 	// MCU_ADDRESS [MODE_SENSOR_LINE_LENGTH_PCK_B]                                         
//	{0x0990, 0x0888, I2C_16BIT}, 	// MCU_DATA_0   //sam 0x0C24                                                                        
//	{0x0990, 0x0C24, I2C_16BIT}, 	// MCU_DATA_0   //sam 0x0C24                                                                        
	{0x0990, 0x0A1E, I2C_16BIT}, 	// MCU_DATA_0   /* //&*&*&*CJ1_20110830 to fix camera sensor horizontal noise issue. */
...
//	{0x0990, 0x0026, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x0033                                                                     
	{0x0990, 0x0033, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x0033                                                                     
	{0x098C, 0xA409, I2C_16BIT}, 	// MCU_ADDRESS [FD_SEARCH_F2_50]                                                       
//	{0x0990, 0x0029, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x0035                                                                     
	{0x0990, 0x0035, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x0035                                                                     
	{0x098C, 0xA40A, I2C_16BIT}, 	// MCU_ADDRESS [FD_SEARCH_F1_60]                                                       
//	{0x0990, 0x002E, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x003E                                                                    
	{0x0990, 0x003E, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x003E                                                                    
	{0x098C, 0xA40B, I2C_16BIT}, 	// MCU_ADDRESS [FD_SEARCH_F2_60]                                                       
//	{0x0990, 0x0031, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x0040                                                                      
	{0x0990, 0x0040, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x0040                                                                      
	{0x098C, 0x2411, I2C_16BIT}, 	// MCU_ADDRESS [FD_R9_STEP_F60_A]                                                      
//	{0x0990, 0x00A0, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x00D3                                                                     
	{0x0990, 0x00D3, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x00D3                                                                     
	{0x098C, 0x2413, I2C_16BIT}, 	// MCU_ADDRESS [FD_R9_STEP_F50_A]                                                      
//	{0x0990, 0x00C0, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x00FD                                                                     
//	{0x0990, 0x00FD, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x00FD                                                                           
	{0x0990, 0x00FE, I2C_16BIT}, 	// MCU_DATA_0     //sam 0x00FD                                                                           
	{0x098C, 0x2415, I2C_16BIT}, 	// MCU_ADDRESS [FD_R9_STEP_F60_B]                                                      
//	{0x0990, 0x00A0, I2C_16BIT}, 	// MCU_DATA_0      //sam 0x0071                                                                    
	{0x0990, 0x0071, I2C_16BIT}, 	// MCU_DATA_0      //sam 0x0071                                                                    
	{0x098C, 0x2417, I2C_16BIT}, 	// MCU_ADDRESS [FD_R9_STEP_F50_B]                                                      
//	{0x0990, 0x00C0, I2C_16BIT}, 	// MCU_DATA_0      //sam 0x0087                                                                    
	{0x0990, 0x0087, I2C_16BIT}, 	// MCU_DATA_0      //sam 0x0087                                                                    
...
//EP10 GAMMA for exposure   // 2011-07-08
	{0x098C, 0x2212, I2C_16BIT}, 	// MCU_ADDRESS [AE_MAX_DGAIN_AE1]                                                        
//	{0x0990, 0x0064, I2C_16BIT}, 	// MCU_DATA_0                                                                            
	{0x0990, 0x00C8, I2C_16BIT}, 	// MCU_DATA_0                                                                            
	{0x098C, 0xA216, I2C_16BIT}, 	// MCU_ADDRESS [AE_MAXGAIN23]                                                            
	{0x0990, 0x0038, I2C_16BIT}, 	// MCU_DATA_0                                                                            

//EP10 GAMMA for sharpness  // 2011-07-12
...
//	{0x0990, 0x00DF, I2C_16BIT}, 	// MCU_DATA_0                                                                
//	{0x098C, 0xAB4B, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_15]                                         
//	{0x0990, 0x00E8, I2C_16BIT}, 	// MCU_DATA_0                                                                
//	{0x098C, 0xAB4C, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_16]                                         
//	{0x0990, 0x00F0, I2C_16BIT}, 	// MCU_DATA_0                                                                
//	{0x098C, 0xAB4D, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_17]                                         
//	{0x0990, 0x00F8, I2C_16BIT}, 	// MCU_DATA_0                                                                
//	{0x098C, 0xAB4E, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_18]                                         
//	{0x0990, 0x00FF, I2C_16BIT}, 	// MCU_DATA_0                                                                

//GAMMA  , Gamma=0.4, black=4,contrast=1.35  // 2011-08-02 for sharpness and AE
	{0x098C, 0xAB3C, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_0]                       
	{0x0990, 0x0000, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB3D, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_1]                       
	{0x0990, 0x000F, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB3E, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_2]                       
	{0x0990, 0x0028, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB3F, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_3]                       
	{0x0990, 0x0042, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB40, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_4]                       
	{0x0990, 0x0069, I2C_16BIT}, 	// MCU_DATA_0 =>ORI:0x0064                                
	{0x098C, 0xAB41, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_5]                       
	{0x0990, 0x0083, I2C_16BIT}, 	// MCU_DATA_0 =>ORI:0x007F                                
	{0x098C, 0xAB42, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_6]                       
	{0x0990, 0x0094, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB43, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_7]                       
	{0x0990, 0x00A5, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB44, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_8]                       
	{0x0990, 0x00B4, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB45, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_9]                       
	{0x0990, 0x00BF, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB46, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_10]                      
	{0x0990, 0x00CA, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB47, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_11]                      
	{0x0990, 0x00D3, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB48, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_12]                      
	{0x0990, 0x00DB, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB49, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_13]                      
	{0x0990, 0x00E2, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB4A, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_14]                      
	{0x0990, 0x00E9, I2C_16BIT}, 	// MCU_DATA_0                                             
	...
	{0x0990, 0x00EF, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB4C, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_16]                      
	{0x0990, 0x00F5, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB4D, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_17]                      
	{0x0990, 0x00FA, I2C_16BIT}, 	// MCU_DATA_0                                             
	{0x098C, 0xAB4E, I2C_16BIT}, 	// MCU_ADDRESS [HG_GAMMA_TABLE_A_18]                      
	{0x0990, 0x00FF, I2C_16BIT}, 	// MCU_DATA_0                                             
...
//AE window				// 2011-08-02 for sharpness and AE
	{0x098C, 0xA202, I2C_16BIT}, 	// MCU_ADDRESS [AE_WINDOW_POS]            
	{0x0990, 0x0041, I2C_16BIT}, 	// MCU_DATA_0                             
	{0x098C, 0xA203, I2C_16BIT}, 	// MCU_ADDRESS [AE_WINDOW_SIZE]           
	{0x0990, 0x009D, I2C_16BIT}, 	// MCU_DATA_0                             
//	{0x098C, 0xA103, I2C_16BIT}, 	// MCU_ADDRESS [SEQ_CMD]                  
//	{0x0990, 0x0006, I2C_16BIT}, 	// MCU_DATA_0                             
...
//	{0x0990, 0x046F, I2C_16BIT}, 	// MCU_DATA_0					//verticalflip
	{0x0990, 0x046C, I2C_16BIT}, 	// MCU_DATA_0	//verticalflip //&*&*&*CJ_20110831_mod: Camera recording content is not correct will rotate 180 degree
	{0x098C, 0x272D, I2C_16BIT}, 	// MCU_ADDRESS [MODE_SENSOR_READ_MODE_B]	//verticalflip
//	{0x0990, 0x0027, I2C_16BIT}, 	// MCU_DATA_0					//verticalflip
	{0x0990, 0x0024, I2C_16BIT}, 	// MCU_DATA_0	//verticalflip //&*&*&*CJ_20110831_mod: Camera recording content is not correct will rotate 180 degree
