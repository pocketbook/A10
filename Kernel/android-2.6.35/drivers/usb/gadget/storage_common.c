...
static int fsg_lun_open(struct fsg_lun *curlun, const char *filename)
{
	...
	//printk("open backing file: %s\n", filename);
	rc = 0;
//&*&*&*BC1_110720: fix issue that cpu can not run 300 Mhz issue
	/* Hold 800 MHz MPU constarint */
//	omap_pm_set_min_mpu_freq((struct device *) curlun, 800000000);
//&*&*&*BC2_110720: fix issue that cpu can not run 300 Mhz issue
out:
