...
static int mt9d115_sensor_set_prv_data(struct v4l2_int_device *s, void *priv)
{
	...
	hwc->dev_index		= 2;
	hwc->dev_minor		= 5;
//	hwc->dev_type		= OMAP34XXCAM_SLAVE_SENSOR;	//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
	hwc->dev_type		= OMAP34XXCAM_SLAVE_SENSOR0;	//&*&*&*CJ_20110811_mod: follow TI MMS' solution for camera driver
