...
//&*&*&*HC1_20110613_Mod, correct the key mapping according to EP10 Artwork (v1.2)
//&*&*&*HC1_20110225_Add, modify for EP10
static int ep10_twl4030_keymap[] = {
	/*	row, col, key_val	*/
	KEY(0, 0, KEY_VOLUMEDOWN),	/* VOLUMEDOWN */
	KEY(0, 1, KEY_PAGEUP),		/* PAGEUP */			/*EVT3 add*/
	KEY(0, 2, KEY_PAGEDOWN),		/* PAGEDOWN */		/*EVT3 add*/
	KEY(1, 0, KEY_VOLUMEUP),		/* VOLUMEUP */
	KEY(1, 1, KEY_SEARCH),		/* SEARCH */		
	KEY(1, 2, KEY_HOME),			/* HOME */
	KEY(2, 1, KEY_BACK),			/* BACK */
	KEY(2, 2, KEY_MENU),			/* MENU */
};
//&*&*&*HC2_20110613_Mod, correct the key mapping according to EP10 Artwork (v1.2)

static struct matrix_keymap_data ep10_map_data = {
	.keymap			= ep10_twl4030_keymap,
	.keymap_size		= ARRAY_SIZE(ep10_twl4030_keymap),
};

static struct twl4030_keypad_data ep10_kp_twl4030_data = {
	.keymap_data	= &ep10_map_data,
	.rows		= 3,
	.cols		= 3,
//&*&*&*BC1_110825: disable linux input autorepeat keyevent function to avoid android autorepeat keyevent timing issue
	.rep		= 0,
//&*&*&*BC2_110825: disable linux input autorepeat keyevent function to avoid android autorepeat keyevent timing issue	
};
...
#define OMAP_MAX8903_CHG_GPIO 149
