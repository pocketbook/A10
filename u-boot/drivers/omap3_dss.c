...
//		dss_write_reg(0x48310094, 0x01000120);
		...
		dss_write_reg(OMAP3621_CM_CLKSEL_DSS, 0x00001005/*0x00001006*/); // TV/16, DSS/5   TFT use 0x00001005, EPD 9" use 0x00001006
...
void omap3_dss_gfx_config(void)
{
       ...
       dss_write_reg(OMAP3621_DISPC_GFX_SIZE, 0x02ff03ff);   //DISPC_GFX_SIZE -> 767x1023   
