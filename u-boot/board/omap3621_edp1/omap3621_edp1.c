...
enum BoardID_enum GetHardwareID(unsigned int val)
{
	...
	else if ((val > 1413)&&(val <= 1500))	id = BOARD_ID_MP;
...
#define MUX_DEFAULT_ES2()\
	...
	MUX_VAL(CP(GPMC_D10),       (IDIS | PTD | EN | OFF_IN_PD | M4)) /*GPIO-46, CCM_RESET_N*/\
	...
	MUX_VAL(CP(ETK_D8_ES2 ),    (IDIS | PTU | DIS | OFF_OUT_PU/*| OFF_OUT_PD*/ | M4)) /*WL_BT_POW_EN, GIO-22 Always ON*/\
